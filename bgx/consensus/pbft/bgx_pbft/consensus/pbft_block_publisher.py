...
class PbftBlockPublisher(BlockPublisherInterface):
    ...
    def initialize_block(self, block_header):
        ...
        # start 
        if consensus_state:
            consensus_state.start_consensus(block_header,self._block_cache,self._state_view_factory,self._consensus_state_store)
        #consensus_state.next_step()
        #self._consensus_state_store[block_header.previous_block_id] = consensus_state
        ...
        if pbft_key_state is None and _VREG_:
    ...
    def finalize_block(self, block_header):
        ...
        """
        LOGGER.debug('PbftBlockPublisher::finalize_block: consensus=%s (%s)',block_header.consensus,block_header)
