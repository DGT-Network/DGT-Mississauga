...
class ValidatorRegistryView:
    ...
    def get_validators(self):
        ...
        #LOGGER.debug("BgxValidatorInfo::get_validators type=%s leaves(%s)",type(leaves),leaves)
        infos = [
    ...
    def get_validator_info(self, validator_id):
        ...
        """
        #LOGGER.debug("BgxValidatorInfo::get_validator_info get state_data for(%s)",validator_id)
        state_data = self._state_view.get(ValidatorRegistryView._to_address(validator_id))
        #LOGGER.debug("BgxValidatorInfo::get_validator_info state_data(%s)",state_data)
